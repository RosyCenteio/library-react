                    ...
                    <div className="row">
                        ...
                        <div className="cart">
                                            ...
                                            <div className="cart__item">
                                                <div className="cart__book">
                                                    ...
                                                    <div className="cart__book--info">
                                                        ...
                                                        {book.salePrice ? `$${book.salePrice.toFixed(2)}`  : `$${book.originalPrice.toFixed(2)}`}
                                                        </span>
                            ...
                            {cart.length === 0 && <div className="cart__empty">
                                ...
                                <h2>Your don't have any books on your cart</h2>
                                <Link to='/books'>
                        ...
                        {cart.length > 0 && <div className="total">
                            ...
                            <button className='btn btn__checkout no-cursor' onClick={() => alert('to be implemented!')}>
                                Proceed to Checkout
                            </button>
                        </div>
                        }   
